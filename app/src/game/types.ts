...
export interface GameState {
  screen: 'title' | 'levelSelect' | 'playing' | 'paused' | 'levelComplete' | 'gameOver' | 'leaderboard' | 'artifacts' | 'settings' | 'howToPlay' | 'intro' | 'travel' | 'rewards' | 'samarkandIntro' | 'registan' | 'mosaic';
  currentLevel: number;
  score: number;
  coins: number;
  distance: number;
